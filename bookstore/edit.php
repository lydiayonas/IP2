...
<body>
    ...
    <form method="POST">
        ...
        Tilte: <input type="text" name="title" value="<?php echo $book['title']; ?>" required><br>
        ...
        Published Year: <input type="number" name="published_year" min="1900" max="2100"  value="<?php echo $book['published_year']; ?>"><br>
